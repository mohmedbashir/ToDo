...
class Task {
  ...
  factory Task.fromJson(Map<String, dynamic> json) {
    return Task(
      ...
      isComplete: json['isComplete'] != null ? json['isComplete'] as int : null,
  ...
  @override
  String toString() {
    return 'Task(id: $id, title: $title, note: $note, isComplete: $isComplete, date: $date, startTime: $startTime, endTime: $endTime, color: $color, remind: $remind, repeat: $repeat)';
  }
}
